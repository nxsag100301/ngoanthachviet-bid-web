  ...
  return (
    <div>
      <div className='p-2 sm:p-6 md:p-3 lg:p-6 rounded-[12px] border border-gray-100 bg-blue-50 space-y-3 sm:space-y-6'>
        ...
        <div className='px-2 py-1 sm:px-6 sm:py-4 md:px-4 md:py-2 lg:px-6 lg:py-4 rounded-[12px] border border-gray-100 bg-white space-y-6'>
          <div className='flex flex-col gap-2 sm:gap-3'>
            <p className='text-[14px] sm:text-[18px] md:text-[14px] lg:text-[18px] leading-[26px] text-gray-950'>
              Chưa tham gia
            </p>
            <div className='flex flex-row justify-between'>
              <p className='text-[14px] sm:text-[18px] md:text-[14px] lg:text-[18px] leading-[26px] text-text-500'>
                Giá hiện tại
              </p>
              <p className='text-[14px] sm:text-[18px] md:text-[14px] lg:text-[18px] leading-[26px] text-text-950 font-semibold'>
                10.000.000 VND
              </p>
            </div>
            <div className='flex flex-row justify-between'>
              <Chip label={'Tự động đặt giá'} type='error' />
              <p className='text-[14px] sm:text-[18px] md:text-[14px] lg:text-[18px] leading-[26px] text-success-600 font-semibold'>
                Đang dẫn đầu
              </p>
            </div>
            <div className='flex flex-row justify-between'>
